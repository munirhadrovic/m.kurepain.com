<?php
	$adresa="116 Defense Highway Suite 403 Annapolis, MD 21401"; //jako je vazno navesti dobro adresu radi boljeg poziciniranja
	$grad="";//jako je vazno ako adresa ima dva imena povezati ih sa plus
	$skracenica=""; // AKo ne znate skracenicu ostavite praznu
	$telephone=8009972460 ;// Broj koji se poziva na dugme CALL US
